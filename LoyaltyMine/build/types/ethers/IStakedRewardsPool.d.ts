...
interface IStakedRewardsPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IStakedRewardsPool extends Contract {
  ...
  interface: IStakedRewardsPoolInterface;
