...
interface MockStakedRewardsPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockStakedRewardsPool extends Contract {
  ...
  interface: MockStakedRewardsPoolInterface;
